...
;
const metadata = {
    title: "CryptoGecko Pro - Live Cryptocurrency Prices & Market Data",
    description: "Track 100+ cryptocurrencies in real-time with live prices, market caps, 24h volume, trending coins, portfolio tracking, and advanced converter. Professional crypto market data powered by CoinGecko API.",
    generator: "v0.app",
    icons: {
        icon: [
            {
